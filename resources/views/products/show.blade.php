...
<div class="flex flex-col items-center  mx-auto mt-20 max-w-5xl p-5  shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
    ...
    <ul>
        ...
        <a href="/products"><button class="border opacity-80 relative font-bold border-gray-950 px-4 py-2 rounded-md bg-slate-300 hover:bg-slate-500 ">Return</button></a>
    </ul>
</div>